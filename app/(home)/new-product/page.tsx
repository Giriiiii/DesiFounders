                    ...
                    <div
                     ...
                     ${
                       selectedCategories.includes(category)
                         ? "bg-[#444ce7] text-white rounded-full"
                         : "text-black"
                     }`}
                    >
                      {category}
          ...
          <div className="space-y-10">
            ...
            <div className="flex flex-col  gap-4">
              <div
                ...
                className="bg-[#444ce7] text-white py-2 px-4
              ...
              <div
                ...
                className="text-[#444ce7] py-2 px-4 rounded mt-4 
              ...
              <div className="flex items-center">
                {step === 7 ? (
                  <button
                    ...
                    className="bg-[#444ce7] text-white py-2 px-4 rounded-md mt-4 items-end"
                  >
                    Submit
                  </button>
                ) : (
